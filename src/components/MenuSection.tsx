...
const dishes: Dish[] = [
  {
    ...
    image: "https://via.placeholder.com/600x800?text=Pulpo+a+la+brasa",
    tag: "Plato estrella",
  },
  {
    name: "Tartar de atún rojo",
    description: "Atún rojo de almadraba, aguacate, brotes frescos y un aliño sutil de soja y sésamo.",
    image: "https://via.placeholder.com/600x800?text=Tartar+de+atún+rojo",
    tag: "De la Bahía",
  },
  {
    name: "Carpaccio de gambas de Sanlúcar",
    description: "Pescado del día marinado en leche de tigre con maíz crujiente y hierbas de la huerta.",
    image: "https://via.placeholder.com/600x800?text=Carpaccio+de+gambas",
    tag: "Temporada",
  },
  {
    name: "Chicharrones",
    description: "Selección del día, a la plancha con limón de la tierra y un hilo de aceite virgen extra.",
    image: "https://via.placeholder.com/600x800?text=Chicharrones",
    tag: "Clásico",
  },
  {
    name: "Tarta de queso payoyo",
    description: "Postre típico de la región, con textura cremosa y sabor intenso.",
    image: "https://via.placeholder.com/600x800?text=Tarta+de+queso+payoyo",
    tag: "Postre",
  },
];
              ...
              >
                <div className="overflow-hidden rounded-sm">
                  <motion.img
                    ...
                    src={dish.image}
                    alt={dish.name}
                    className={`w-full object-cover grayscale-[0.15] transition-[filter] duration-700 group-hover:grayscale-0 ${
